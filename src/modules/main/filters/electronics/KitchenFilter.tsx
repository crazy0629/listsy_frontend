...
export const KitchenFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        ...
        itemSellerRating: selectData.forSale.Kitchen.SellerRating,
        itemCondition: selectData.forSale.Kitchen.Condition,
