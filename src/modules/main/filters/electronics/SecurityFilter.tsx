...
export const SecurityFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Security and Surveillance Equipment",
        itemSellerRating: selectData.forSale.Security.SellerRating,
        itemCondition: selectData.forSale.Security.Condition,
        itemWarrantyInformation:
          selectData.forSale.Security.WarrantyInformation,
        itemType: selectData.forSale.Security.Type,
