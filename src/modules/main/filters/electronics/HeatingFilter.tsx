...
export const HeatingFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Heating, Cooling, and Air Quality",
        itemSellerRating: selectData.forSale.Heating.SellerRating,
        itemCondition: selectData.forSale.Heating.Condition,
        itemBrand: selectData.forSale.Heating.Brands,
        itemWarrantyInformation: selectData.forSale.Heating.WarrantyInformation,
        itemType: selectData.forSale.Heating.Type,
