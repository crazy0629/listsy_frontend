...
export const BatteryFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Batteries and Power Supplies",
        itemSellerRating: selectData.forSale.Batteries.SellerRating,
        itemCondition: selectData.forSale.Batteries.Condition,
        itemWarrantyInformation:
          selectData.forSale.Batteries.WarrantyInformation,
        itemType: selectData.forSale.Batteries.Type,
