...
export const LaundryFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Laundry Appliances",
        itemSellerRating: selectData.forSale.Laundry.SellerRating,
        itemCondition: selectData.forSale.Laundry.Condition,
