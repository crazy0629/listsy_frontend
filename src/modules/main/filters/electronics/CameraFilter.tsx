...
export const CameraFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Cameras and Camcorders",
        itemSellerRating: selectData.forSale.Camera.SellerRating,
        itemCondition: selectData.forSale.Camera.Condition,
        ...
        {isAdvancedFilter && (
          <>
            ...
            <MultiSelection
              ...
              type="itemMegapixels"
              countList={adCnt.itemMegapixels}
            />
            <MultiSelection
