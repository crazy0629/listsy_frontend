...
export const IpadFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "iPad, Tablets & eReaders",
        itemSellerRating: selectData.forSale.Ipad.SellerRating,
        itemCondition: selectData.forSale.Ipad.Condition,
        itemType: selectData.forSale.Ipad.Type,
        itemScreenSize: selectData.forSale.Ipad.ScreenSize,
        itemStorage: selectData.forSale.Ipad.Storage,
        itemMemory: selectData.forSale.Ipad.Memory,
        itemBatteryLife: selectData.forSale.Ipad.BatteryLife,
        ...
        {isAdvancedFilter && (
          <>
            ...
            <MultiSelection
              ...
              onChange={(value) =>
                setFilter((prev) => ({ ...prev, storage: value }))
              }
              type="itemStorage"
              countList={adCnt.itemStorage}
            />
            <MultiSelection
              ...
              value={filter.memory}
              onChange={(value) =>
                setFilter((prev) => ({ ...prev, memory: value }))
              }
              type="itemMemory"
              countList={adCnt.itemMemory}
            />
            <MultiSelection
