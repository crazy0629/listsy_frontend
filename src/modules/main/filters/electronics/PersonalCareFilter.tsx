...
export const PersonalCareFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Personal Care Appliances",
        itemSellerRating: selectData.forSale.PersonalCare.SellerRating,
        itemCondition: selectData.forSale.PersonalCare.Condition,
        itemBrand: selectData.forSale.PersonalCare.Brands,
  ...
  return (
    <FilterWrapper>
      {adCnt != null && (
        <>
          <SingleSelection
            data={selectData.forSale.PersonalCare.SearchWithin}
          ...
          <MultiSelection
            data={selectData.forSale.PersonalCare.Condition}
          ...
          />
          <MultiSelection
            data={selectData.forSale.PersonalCare.Type}
          ...
          />
          <MultiSelection
            data={selectData.forSale.PersonalCare.Brands}
          ...
          />
          <MultiSelection
            data={selectData.forSale.PersonalCare.WarrantyInformation}
          ...
          />
          <MultiSelection
            data={selectData.forSale.PersonalCare.SellerRating}
