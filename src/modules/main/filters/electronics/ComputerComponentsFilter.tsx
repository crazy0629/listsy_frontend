...
export const ComputerComponentFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Computer Components and Storage",
        itemSellerRating: selectData.forSale.ComputerComponents.SellerRating,
        itemCondition: selectData.forSale.ComputerComponents.Condition,
        itemBrand: selectData.forSale.ComputerComponents.Brand,
        itemWarrantyInformation:
          selectData.forSale.ComputerComponents.WarrantyInformation,
