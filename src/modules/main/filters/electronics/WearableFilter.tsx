...
export const WearableFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        ...
        itemSellerRating: selectData.forSale.Wearable.SellerRating,
        itemCondition: selectData.forSale.Wearable.Condition,
        itemBrand: selectData.forSale.Wearable.Brand,
        itemWarrantyInformation:
          selectData.forSale.Wearable.WarrantyInformation,
        itemType: selectData.forSale.Wearable.Type,
    ...
    <FilterWrapper>
      {adCnt != null && (
        <>
          ...
          <MultiSelection
            data={selectData.forSale.Wearable.Condition}
          ...
          />
          <MultiSelection
            data={selectData.forSale.Wearable.Type}
          ...
          />
          <MultiSelection
            data={selectData.forSale.Wearable.Brand}
          ...
          />
          <MultiSelection
            data={selectData.forSale.Wearable.WarrantyInformation}
          ...
          />
          <MultiSelection
            data={selectData.forSale.Wearable.SellerRating}
