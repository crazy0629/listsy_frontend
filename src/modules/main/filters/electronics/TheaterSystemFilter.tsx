...
export const TheaterSystemFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Home Theater Systems",
        itemSellerRating: selectData.forSale.TheaterSystems.SellerRating,
        itemCondition: selectData.forSale.TheaterSystems.Condition,
        itemBrand: selectData.forSale.TheaterSystems.Brand,
