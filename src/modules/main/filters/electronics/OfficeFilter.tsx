...
export const OfficeFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        ...
        itemSellerRating: selectData.forSale.OfficeEquipment.SellerRating,
        itemCondition: selectData.forSale.OfficeEquipment.Condition,
        itemWarrantyInformation:
          selectData.forSale.OfficeEquipment.WarrantyInformation,
        itemType: selectData.forSale.OfficeEquipment.Type,
