...
export const AudioFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        ...
        itemSellerRating: selectData.forSale.Audio.SellerRating,
  ...
  return (
    adCnt != null && (
      <>
        ...
        <SingleSelection
          data={selectData.forSale.Audio.SearchWithIn}
        ...
        {isAdvancedFilter && (
          <>
            ...
            />
            <MultiSelection
              data={selectData.forSale.Audio.SellerRating}
