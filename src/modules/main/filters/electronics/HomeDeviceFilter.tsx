...
export const HomeDeviceFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Smart Home Devices",
        itemSellerRating: selectData.forSale.HomeDevice.SellerRating,
        itemCondition: selectData.forSale.HomeDevice.Condition,
        itemWarrantyInformation:
          selectData.forSale.HomeDevice.WarrantyInformation,
        itemType: selectData.forSale.HomeDevice.Type,
