...
export const MusicFilter: React.FC<Props> = ({ onChange }) => {
  ...
  const donetyping = async () => {
    ...
    const adsCountData = await axios.post(
      `${SERVER_URI}/sale/getCountOfEachFilter`,
      {
        minPrice: minPrice,
        maxPrice: maxPrice,
        itemCategory: "Portable Music Players",
        itemSellerRating: selectData.forSale.Music.SellerRating,
        itemCondition: selectData.forSale.Music.Condition,
        itemBrand: selectData.forSale.Music.Brands,
        ...
        {isAdvancedFilter && (
          <>
            ...
            <MultiSelection
              ...
              type="itemConnectivity"
              countList={adCnt.itemConnectivity}
            />
            <MultiSelection
              ...
              type="itemSupportedStandards"
              countList={adCnt.itemSupportedStandards}
            />
            <MultiSelection
